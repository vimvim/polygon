...
{
  // 'custom 2': function () {
  //   return custom(tests, 2, 0)
  // },
  // 'customWs 2': function () {
  //   return customWs(tests, 2, 0)
  // },
  ...
  //   return util.inspect(tests, false, 1, false)
  // },
  // 'util.inspect undefined': function () {
  //   util.inspect(tests)
  // },
  // 'util.inspect 2': function () {
  //   util.inspect(tests, false, 2, false)
  // },
  // 'util.inspect 3': function () {
  //   util.inspect(tests, false, 3, false)
  // },
  // 'util.inspect 4': function () {
  //   util.inspect(tests, false, 4, false)
  // },
  // 'util.inspect Infinity': function () {
  //   util.inspect(tests, false, Infinity, false)
  // }
}
